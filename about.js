...
const firebaseConfig = {
    apiKey: "AIzaSyCWdtsJQ_A6BnJ8mX9Y3St5xPJA0NGve5s",
    authDomain: "g-result-16d63.firebaseapp.com",
    projectId: "g-result-16d63",
    storageBucket: "g-result-16d63.firebasestorage.app",
    messagingSenderId: "678771171699",
    appId: "1:678771171699:web:fddce1958ef95176fae506",
    measurementId: "G-5N8B8CKRMN"
};
...
function render() {
    ...
    head += `<th class="cell-total" style="background:#1b3b1b; color:white;">মোট</th><th class="cell-pct" style="background:#1b3b1b; color:white;">%</th><th class="cell-gpa" style="background:#1b3b1b; color:white;">GPA</th><th class="cell-res" style="background:#1b3b1b; color:white;">ফলাফল</th><th class="cell-pos" style="background:#1b3b1b; color:white;">মেধা</th>`;
...
(function() {
    ...
    function updateRotationsForMobile() {
        ...
        const desktopRotations = [20, -14, 8, -12, 14, -15, 16, -20];
        const tabletRotations = [10, -7, 5, -6, 7, -8, 8, -10];
        const mobileRotations = [5, -4, 3, -3, 4, -5, 5, -6];
        
        const desktopTranslations = [-3, 2, -4, 1, -2, 3, -1, 2];
        const tabletTranslations = [-2, 1, -2, 1, -1, 2, -1, 1];
        const mobileTranslations = [-1, 1, -1, 0, -1, 1, 0, 1];
